...
- Important: When you change the roulette page or its client component, increment the version number shown in the header of `src/app/roulette/roulette-client.tsx` (for example `(v1.7)`), and update this instructions file with the new version. This ensures the UI version and changelog stay in sync.
...
- [ ] Roulette component with animations (v1.5)
