        ...
        <div className="min-h-screen p-6" style={{ backgroundColor: '#d4c4a8', fontFamily: 'Inter, system-ui, -apple-system, sans-serif' }}>
            <div className="max-w-6xl mx-auto">
                ...
                <Dialog open={isEditDialogOpen} onOpenChange={setIsEditDialogOpen}>
                    <DialogContent className="border-2" style={{ backgroundColor: '#e8d8b9', borderColor: '#3d4a6b' }}>
                        <DialogHeader>
                            <DialogTitle style={{ color: '#3d4a6b' }}>Categorie Bewerken</DialogTitle>
                        ...
                        {editingType && (
                            <form action={handleUpdateType} className="space-y-3">
                                ...
                                <div>
                                    <Label htmlFor="edit-name" className="px-2 py-1 text-sm font-medium" style={{ color: '#3d4a6b' }}>Naam *</Label>
                                    <Input
                                        id="edit-name"
                                        name="name"
                                ...
                                <div>
                                    <Label htmlFor="edit-description" className="px-2 py-1 text-sm font-medium" style={{ color: '#3d4a6b' }}>Beschrijving</Label>
                                    <Textarea
                                        id="edit-description"
                                        name="description"
